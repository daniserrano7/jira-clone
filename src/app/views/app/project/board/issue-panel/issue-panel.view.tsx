...
import { Issue, IssueData, todoIssuesMock1 } from "@domain/issue";
...
export const IssuePanel = ({ issueData }: Props): JSX.Element => {
  ...
  const issue = new Issue(todoIssuesMock1[0]);
  ...
  return (
    <div className="absolute top-0 left-0 z-50 box-border grid h-full w-full place-items-center overflow-y-auto bg-black bg-opacity-50 px-[40px]">
      <Form method="post" className="rounded-lg bg-white">
        <h1>ISSUE: {issueData.name}</h1>
